...
const string GET_ALL_USERS = "SELECT USER_ID, GITHUB_ID, LOGIN_NAME, NAME, COMPANY, EMAIL, PROFILE_URL, WEBSITE_URL " +
        "FROM ENGAPP_GITHUB_USERS;";
const string GET_ALL_ORG_USERS = "SELECT ORG_ID, USER_ID FROM ENGAPP_GITHUB_ORGANIZATION_USERS;";
...
const string UPDATE_REPOSITORY = "UPDATE ENGAPP_GITHUB_REPOSITORIES SET REPOSITORY_NAME=?, URL=?, ORG_ID=?, REPOSITORY_TYPE=? " + 
		"WHERE REPOSITORY_ID=?";
const string UPDATE_USER = "UPDATE ENGAPP_GITHUB_USERS SET LOGIN_NAME = ?, NAME = ?, COMPANY = ?, EMAIL = ?, PROFILE_URL = ?, " +
                "WEBSITE_URL = ? WHERE USER_ID = ?;";
const string INSERT_USER = "INSERT INTO ENGAPP_GITHUB_USERS(GITHUB_ID, LOGIN_NAME, NAME, COMPANY, EMAIL, PROFILE_URL, WEBSITE_URL) " + 
                "VALUES (?, ?, ?, ?, ?, ?, ?);";
const string DELETE_ORG_USER = "DELETE FROM ENGAPP_GITHUB_ORGANIZATION_USERS WHERE ORG_ID = ? AND USER_ID = ?;";
const string INSERT_ORG_USER = "INSERT INTO ENGAPP_GITHUB_ORGANIZATION_USERS (ORG_ID, USER_ID) VALUES (?, ?);";
